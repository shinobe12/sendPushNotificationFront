    ...
    <main className='min-h-screen dark:bg-[#fff] bg-zinc-950'>
        ...
        <div className='flex justify-start p-3'>
          ...
          <div>
            ...
            {isDark ? 
              ...
              <svg width="42" height="22" className='lg:mt-1 p-1 lg:p-0' viewBox="0 0 42 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className='mt-3'>
             {mostrItems && <ul className='fixed justify-end bg-opacity-30 rounded-md backdrop-blur-md animate-fade justify-end p-3 bg-zinc-300 lg:flex lg:bg-opacity-0  lg:w-[20%] dark:text-zinc-800 my-2 ml-3 lg:ml-[25%] '>
            ...
            <button type='button' className='lg:hidden ml-[80%] rounded-md' onClick={trocaChange}>
              {isChange &&
                <svg onClick={trocaMostrar} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
              className="lucide lucide-circle-x animate-fade dark:text-[#277FE3] "><circle cx="12" cy="12" r="10"/><path d="m15 9-6 6"/><path d="m9 9 6 6"/></svg>
              }
              {!isChange &&
                ...
                stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-menu animate-fade dark:text-[#277FE3]"><line x1="4" x2="20" y1="12" y2="12"/>
      ...
      <div className='flex justify-center h-10 '>
          <div className="text-zinc-50 sitky top-0 flex justify-between p-4 h-20 rounded-md bg-zinc-800 dark:bg-[#E8F3FF]" >
            <button className={`${activeStyleList} lg:mr-3 p-1 lg:p-3 lg:hover:bg-zinc-700 rounded-md`} onClick={e => {setAction("LIST")}}>Lista de Notificações</button> 
            <button className={`${activeStyleAdd} ml-3 p-1 lg:p-3 lg:hover:bg-zinc-700   rounded-md`} onClick={e => {setAction("ADD")}}>Adicionar Notificação</button>  
          </div> 
      </div> 
