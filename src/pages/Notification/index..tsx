  ...
  return (
    ...
    <div className={`${isDark && "dark"}`}>
      ...
      <main className='min-h-screen dark:bg-[#fff] bg-zinc-950 '>
        ...
        <div className="text-zinc-50 flex items-center items-center ">
          ...
          <ul className=' hidden w-[70%] md:w-[35%] ml-[20%] md:ml-[60%] justify-end bg-opacity-30 rounded-md backdrop-blur-md animate-fade justify-end p-3 bg-zinc-300 lg:flex lg:bg-opacity-0 lg:w-[40%] dark:text-zinc-800 my-2 ml-3 lg:ml-[60%] '>
            ...
            {mostrItems && <ul className='dark:shadow-inner mr-10 md:ml-[60%] bg-opacity-30 rounded-md backdrop-blur-md animate-fade p-2 bg-zinc-300 lg:hidden dark:text-zinc-800'>
              ...
              <div className='text-justify mt-1'> 
                <li className='flex justify-start'>
                  <div className='lg:font-semibold text-justify'><p className='text-xs text-justify md:text-sm lg:text-md text-justify'>{email}</p></div>
                </li>
                <li className='lg:font-semibold text-xs md:text-sm flex justify-start'>
                  <span >Admin</span>
                </li>
              </div>
              <li className='flex justify-start'>
        ...
        <div className='flex justify-center h-10'>
          <div className="shadow-inner text-zinc-50 top-0 flex justify-between p-4 h-20 rounded-md bg-zinc-800 dark:bg-[#E8F3FF]" >
            <button className={`${activeStyleList} mr-3 lg:mr-3 p-1 lg:p-3 rounded-md`} onClick={e => { setAction("LIST") }}>Lista de Notificações</button>
            <button className={`${activeStyleAdd} ml-3 p-1 lg:p-3  rounded-md`} onClick={e => { setAction("ADD") }}>Adicionar Notificação</button>
          </div>
        </div>
