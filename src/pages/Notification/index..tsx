  ...
  return (
    ...
    <main className='min-h-screen dark:bg-[#fff] bg-zinc-950 '>
      <div className="text-zinc-50 flex justify-start p-4 h-20 grid grid-cols-2">
        <div className='flex justify-start p-3 mt-2'>
          ...
          <div>
            ...
            {isDark ? 
              <svg width="42" height="22" className='animate-fade mt-1 p-1 lg:p-0 lg:w-8' viewBox="0 0 42 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="42" height="22" rx="11" fill="#4CD080"/>
              <circle cx="31" cy="11" r="9" fill="white"/>
              </svg> : 
              <svg width="42" height="22" className='animate-fade mt-1 p-1 lg:p-0 text-sm lg:w-8' viewBox="0 0 42 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className='flex justify-center h-10'>
          <div className="shadow-inner text-zinc-50 sitky top-0 flex justify-between p-4 h-20 rounded-md bg-zinc-800 dark:bg-[#E8F3FF]" >
            <button className={`${activeStyleList} lg:mr-3 p-1 lg:p-3 rounded-md`} onClick={e => {setAction("LIST")}}>Lista de Notificações</button> 
