                    ...
                    <div>
                        ...
                        <div className="flex justify-between bg-[#fff] rounded-md dark:ring-1 ring-[#eee]">
                            ...
                            <button onClick={trocaPassword} type="button" className="p-2 ">
                                {isShow && <svg width="19" height="13" viewBox="0 0 19 13" fill="none" className="hover:animate-fadeIn" xmlns="http://www.w3.org/2000/svg">
                                ...
                                {!isShow && <svg width="19" height="15" viewBox="0 0 19 15" className="hover:animate-fadeIn" fill="none" xmlns="http://www.w3.org/2000/svg">
