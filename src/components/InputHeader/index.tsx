    ...
    return (
        <main>
            ...
            <div className="flex items-center  bg-white rounded-md">
                <input required disabled={state} className="cursor-pointer
                ...
                <button type="submit" onClick={enviar}>
                    {upload ? !loading ? <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <div role="status" className="flex items-center ml-1">
                ...
                <button type="button" onClick={downloaderImg}>
                        ...
                        {download && <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" className="text-zinc-400 lucide lucide-download animate-fade mr-2 dark: ml-1"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
